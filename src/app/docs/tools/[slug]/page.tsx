          ...
          <section id="inputs-and-outputs" className="space-y-3 pt-4 border-t border-slate-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="p-3.5 rounded-lg border border-slate-200 bg-white space-y-1">
                                                                                <span className="font-bold uppercase tracking-wider text-[10px] text-slate-400">Supported Input</span>
              ...
              <div className="p-3.5 rounded-lg border border-slate-200 bg-white space-y-1">
                                                <span className="font-bold uppercase tracking-wider text-[10px] text-slate-400">Target Output</span>
