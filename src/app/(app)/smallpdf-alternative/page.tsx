...
export const metadata: Metadata = {
  title: `Best Free ${siteConfig.name} Alternative to Smallpdf (No Upload) | ${siteConfig.name}`,
  description: `Looking for a free alternative to Smallpdf? ${siteConfig.name} processes PDFs locally in your browser with no file size limits and no account required.`,
  alternates: {
...
export default function CompetitorAlternativePage() {
  const jsonLdArticle = {
    ...
    "@type": "Article",
    "headline": `Best ${siteConfig.name} Alternative to Smallpdf`,
    "description": `Compare ${siteConfig.name} vs Smallpdf. Find out why our free, open-source PDF tools are the best alternative.`,
  };
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 bg-blue-50 rounded-lg border border-blue-100">
            ...
            <p className="text-blue-800 text-sm">Unlike Smallpdf, which requires you to upload documents to their servers, {siteConfig.name} uses advanced WebAssembly to process PDFs directly in your web browser. This means maximum privacy for sensitive data.</p>
          </div>
