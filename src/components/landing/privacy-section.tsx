...
function FlowDiagram() {
  ...
  return (
    <div className="relative flex flex-col items-stretch p-6 sm:p-8 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-sm">
      {FLOW_STEPS.map((step, i) => {
        ...
        return (
          <div key={step.label} className="relative flex flex-col items-center">
            <div className="relative flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--kp-accent)] text-white shadow-lg shadow-[var(--kp-accent)]/25 ring-1 ring-white/10">
            ...
            {!isLast && (
              <div className="relative flex flex-col items-center my-3 h-12 w-px" aria-hidden="true">
                ...
                {!reducedMotion && (
                  <span
                    className="kp-flow-travel absolute left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[var(--kp-accent)] shadow-[0_0_8px_rgba(194,65,12,0.6)]"
...
export function PrivacySection() {
  return (
    <section id="privacy" className="py-20 sm:py-28 bg-[var(--kp-text)] text-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.03] kp-dot-grid pointer-events-none" aria-hidden="true" />
      <div
        className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-[var(--kp-accent)]/10 blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <Reveal slideX blur>
            <p className="kp-label text-[var(--kp-accent)] mb-4 opacity-80">Privacy first</p>
